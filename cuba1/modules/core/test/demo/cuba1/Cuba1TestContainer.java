...
public class Cuba1TestContainer extends TestContainer {

    public Cuba1TestContainer() {
        super();
    ...
    public static class Common extends Cuba1TestContainer {

        public static final Cuba1TestContainer.Common INSTANCE = new Cuba1TestContainer.Common();
